				...
				<div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-6">
					{products.map((product) => (
						...
						>
							...
							{selected[product.id] && (
								<span className="absolute top-3 right-3 bg-black text-white text-sm w-7 h-7 flex items-center justify-center rounded-full shadow-lg border-2 border-yellow-300 animate-pop">
